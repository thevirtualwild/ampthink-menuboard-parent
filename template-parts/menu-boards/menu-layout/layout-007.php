...
<!-- Start Template File -->
<div id="feature-right-menu" class="left-right-container mx-auto menu-board has-header allow-resize-title <?php the_field('custom_css_class'); ?>">
		...
		if( have_rows('additional_items') ):  ?>
			...
			while ( have_rows('additional_items') ) : the_row();
				...
				if( $menu_item ):
					...
					include( locate_template( 'template-parts/menu-boards/menu-layout/list-items/menu-item.php', false, false ) );
