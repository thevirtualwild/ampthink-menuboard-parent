...
<div id="snackSlider" class="carousel slide" data-ride="carousel">
          ...
          foreach ($item_list as $item_id) {
            ...
            <div class="<?php echo $carouselitemclass;?>">
              ...
              <div class="d-none d-md-block combo-info"> <?php //was carousel-caption ?>
                <h1 class="combo-title animated bounceInLeft"><?php echo $item_title;?></h1>
                <div class="combo-subtitle animated bounceInLeft"><?php echo $item_subtitle;?></div>
                <div class="featured_price price animated bounceInRight"><span class="price-sign">$</span><span class="price-num"><?php echo $item_price; ?></span></div>
              </div>
            </div>
            <?php
            wp_reset_postdata();
