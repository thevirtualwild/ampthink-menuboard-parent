            ...
            <div class="<?php echo $carouselitemclass;?>">
              ...
              <div class="featured-deal-infobox">
                <div class="d-none d-md-block combo-info infobox-wrapper"> <?php //was carousel-caption ?>
                  <div class="item-text animated bounceInLeft">
                    <div class="featured_display_title"><?php echo $item_title;?></div>
                    <div class="featured_display_sub_title"><?php //echo $item_subtitle;?></div>
                  </div>
                  <div class="animated bounceInRight item-price featured_display_price featured_price price"><span class="price-sign">$</span><span class="price-num"><?php echo $item_price; ?></span></div>
                </div>
              </div>
            </div>
            <?php
