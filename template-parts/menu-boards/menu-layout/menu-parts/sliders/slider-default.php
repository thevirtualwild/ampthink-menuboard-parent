          ...
          foreach ($item_list as $item_id) {
            ...
            <div class="<?php echo $carouselitemclass;?>">
              ...
              <div class="d-none d-md-block combo-info"> <?php //was carousel-caption ?>
                ...
                <div class="combo-subtitle animated bounceInRight"><?php echo $item_subtitle;?></div>
                <div class="featured_price price animated bounceInLeft"><span class="price-sign">$</span><span class="price-num"><?php echo $item_price; ?></span></div>
              </div>
            </div>
            <?php
            wp_reset_postdata();
