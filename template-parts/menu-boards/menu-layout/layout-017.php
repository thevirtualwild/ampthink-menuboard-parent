...
<!-- Start Template File -->
<div id="layout-017" class="layout-017 left-right-container mx-auto menu-board <?php the_field('custom_css_class'); ?>">
	...
	<div id="grid-container">
		...
		if( have_rows('featured_items_with_featured') ):

			// loop through the rows of data
			while ( have_rows('featured_items_with_featured') ) : the_row();
        ...
        $calories = get_field('calories');
				...
				include( locate_template( 'template-parts/menu-boards/menu-layout/menu-parts/quadrants/quadrant-with-featured.php', false, false ) );
