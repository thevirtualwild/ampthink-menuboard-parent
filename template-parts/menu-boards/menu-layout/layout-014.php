...
<!-- Start Template File -->
<div id="layout-014" class="mx-auto menu-board layout-014 <?php the_field('custom_css_class'); ?>">
				...
				if( have_rows('additional_items') ):  ?>
					...
					while ( have_rows('additional_items') ) : the_row();
						...
						if( $menu_item ):
							...
							include( locate_template( 'template-parts/menu-boards/menu-layout/menu-parts/list-items/menu-item-with-calorie-in-line.php', false, false ) );
	...
	<div class="menu-list right">
		...
		?>
		<div class="menu-logo"><img src="http://broncos.3.229.112.134.xip.io/wp-content/themes/multi-menu-parent/images/logo-TLC.png"/></div>
	</div>
