<?php
/**
 * Template part for displaying posts - Layout 015 - Four Combos
 *
...
<!-- Start Template File -->
<div id="layout-015" class="layout-015 left-right-container mx-auto menu-board <?php the_field('custom_css_class'); ?>">
