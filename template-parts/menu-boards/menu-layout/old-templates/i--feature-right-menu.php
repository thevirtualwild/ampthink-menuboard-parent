<?php
/**
* Template part for displaying posts - Layout I
*
...
<!-- Start Template File -->
<div id="feature-right-menu" class="left-right-container mx-auto menu-board">
...
// no rows found
	...
	<div id="featured-item-slider" class="right">
		...
		<div class="featured-menu-item">
			<?php include( locate_template( 'template-parts/menu-boards/menu-layout/menu-parts/slider-combos.php', false, false ) ); ?>

			<?php
				/*
				echo do_shortcode( '[rev_slider alias="snacks-left-feature"]' .
